...
class ComputeSourceStatus(Enum):
    ...
    INACTIVE = "INACTIVE"
    """The compute source is either not providing any compute machine instances or any that have been provided are now terminated."""
    ACTIVE = "ACTIVE"
    """The compute source is providing at least one computer machine instance that is not terminated."""
    UPDATING = "UPDATING"
